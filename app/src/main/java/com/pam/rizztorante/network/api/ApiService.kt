...
import com.pam.rizztorante.model.MenuPositionResponse
...
interface ApiService {
  ...
  @DELETE(Endpoints.LOGOUT) suspend fun logout(): Response<Unit>

  @GET(Endpoints.MENUS) suspend fun getMenus(): Response<List<MenuResponse>>
  ...
  @GET(Endpoints.CART) suspend fun getCart(): Response<CartResponse>
  ...
  @GET(Endpoints.POSITION_DETAILS)
  suspend fun getPositionDetails(
          @Path("positionId") positionId: String
  ): Response<MenuPositionDetailsResponse>
}
